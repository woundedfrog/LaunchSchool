...
#OUTPUT: => Bird => Flyable => Animal
#Classes are searched before MODULES, and MODULES are searched(in reverse order[bottom to top of the listed order]) before SUPERCLASSES.